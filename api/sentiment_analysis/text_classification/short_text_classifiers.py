...
def test():
    ...
    test_sentences = ['Dở thế', 'Hay thế', 'phim chán thật', 'nhảm quá', 'không ngon', 'Sao mạnh tay với tác phẩm như vầy thế các bạn. Một tác phẩm giải trí khá ổn cho mọi người, diễn xuất của Angelina Jolie quá tuyệt với cái đơ đơ hài hài. Thông điệp ở đây khá rõ ràng và hết sức cấp thiết: con người đang phá hủy thiên nhiên và mong muốn con người và thiên nhiên sống chan hòa với nhau.']
